...
namespace System.Buffers
{
    public static partial class SpanReaderExtensions
    {
        ...
        /// overloads such as <see cref="TryReadLittleEndian(ref SpanReader{byte}, out short)"/>
        /// </remarks>
        /// <returns>
        /// True if successful. <paramref name="value"/> will be default if failed (due to lack of space).
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe bool TryRead<T>(ref this SpanReader<byte> reader, out T value) where T : unmanaged
        {
